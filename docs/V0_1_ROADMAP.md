...
| 3 | `ENV001`, `ENV003`, and `ENV004` | Complete in this change | [#12](https://github.com/Tanasu0417/execlocus/issues/12) | Each rule has minimum evidence, a legitimate non-triggering setup, deterministic fixtures, and no private agent-state reads |
